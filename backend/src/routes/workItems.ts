...
router.post('/:id/assign', requireRoles('DEPARTMENT_OFFICER', 'STATE_PMU'), async (req, res) => {
...
router.get('/field-officers', requireRoles('DEPARTMENT_OFFICER', 'STATE_PMU'), async (req, res) => {
  const where =
